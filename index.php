...
<div class="background">
  <div class="container">
      ...
      <div class="screen-body">
        ...
        <div class="screen-body-item">
          <div class="app-form">
            ...
            <form method="post">
              <div class="app-form-group">
                <input class="app-form-control" placeholder="Link" name="url1" style='text-transform:none'>
              </div>
    ...
    <marquee behavior="scroll" direction="left" scrollamount="6" onmouseover="this.stop();" onmouseout="this.start();">Please specify http/https before url</marquee>
  </div>
</div>
</body>
</html>
